 ...
 */
public class UCWorkspaceMarqueeHandlerUseCase extends BasicMarqueeHandler {
    ...
    private final UCGraphUseCase graph;

    final ValueModel selectedToolModel;

    final JPopupMenu popupMenu;

    public UCWorkspaceMarqueeHandlerUseCase(final UCGraphUseCase graph,
                                            final ValueModel selectedToolModel,
                                            final JPopupMenu popupMenu
    ) {
        this.graph = graph;
