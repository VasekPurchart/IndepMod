 ...
 */
public class UCWorkspaceTabUseCaseData implements NotationWorkspaceData {

    private static UCGraphUseCase graph;
    private static UCWorkspaceTabUseCase workspace;
    ...
    public UCWorkspaceTabUseCaseData(final ValueModel selectedToolModel,
        ...
        graph = new UCGraphUseCase(uuid, selectedToolModel, popupMenu, actions);
        workspace = new UCWorkspaceTabUseCase(graph, uuid);
    ...
    public UCGraphUseCase getGraph() {
        return graph;
    }
